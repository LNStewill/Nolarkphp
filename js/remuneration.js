...
window.addEventListener("load", function () {
    window.document.querySelector("#btn_calculer").addEventListener("click", function () {
        ...
        // (declenche une erreur dans NetBeans, ne pas en tenir compte !)
        const fixe = 1100.0;
...
/**
 * Fonction qui retourne la comission sur le S20
 * @param {integer} nb 
 * @returns {float} 
 */
...
/**
 * Fonction qui retourne la comission sur le X-Spirit
 * @param {integer} nb 
 * @returns {float} 
 */
...
/**
 *Fonction qui retourge la commission sur le Multitec
 *@param {integer} nb
 *@returns {float}
 */
